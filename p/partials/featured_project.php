                                ...
                                <div class="row gx-9 h-100">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="d-flex flex-column h-100">
                                            <div class="mb-7">
                                                <div class="d-flex flex-stack mb-6">
                                                    <div class="flex-shrink-0 me-5">
                                                        <span
                                                            class="text-gray-400 fs-7 fw-bold me-2 d-block lh-1 pb-1">Öne Çıkan</span>
                                                        <span class="text-gray-800 fs-1 fw-bold">9 Degree</span>
                                                    </div>
                                                    <span
                                                        class="badge badge-light-primary flex-shrink-0 align-self-center py-3 px-4 fs-7">Devam Ediyor</span>
                                                </div>
                                                <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                    <div class="d-flex align-items-center me-5 me-xl-13">
                                                        ...
                                                        <div class="m-0">
                                                            <span
                                                                class="fw-semibold text-gray-400 d-block fs-8">Yönetici</span>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="m-0">
                                                            <span
                                                                class="fw-semibold text-gray-400 d-block fs-8">Bütçe</span>
                                            ...
                                            <div class="mb-6">
                                                <span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">Canlı renklere sahip düz karikatürize çizimler...</span>
                                                <div class="d-flex">
                                                    <div
                                                        ...
                                                        <div class="fw-semibold text-gray-400">Bitiş Tarihi</div>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div class="fw-semibold text-gray-400">Bütçe</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                ...
                                                <a href="dist/apps/projects/project.html"
                                                    class="d-flex align-items-center text-primary opacity-75-hover fs-6 fw-semibold">Projeyi Görüntüle
