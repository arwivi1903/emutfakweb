                        <div class="card card-flush h-md-100">
                            <div class="card-header pt-5 mb-6">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="fs-6 fw-semibold text-gray-400">Ort. Temsilci Kazançları</span>
                                </h3>
                                <div class="card-toolbar">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content fs-6 text-dark fw-bold px-3 py-4">Hızlı İşlemler
                                            </div>
                                        </div>
                                        <div class="separator mb-3 opacity-75"></div>
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">Yeni Bilet</a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">Yeni Müşteri</a>
                                        </div>
                                        <div class="menu-item px-3" data-kt-menu-trigger="hover"
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3">Yönetici Grubu</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3">Personel Grubu</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3">Üye Grubu</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">Yeni Kişi</a>
                                        </div>
                                ...
                                <ul class="nav d-flex justify-content-between mb-3 mx-9">
                                    <li class="nav-item mb-3">
                                        <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active"
                                            ...
                                            href="#kt_charts_widget_35_tab_content_1">1g</a>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                            ...
                                            href="#kt_charts_widget_35_tab_content_2">5g</a>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                            data-bs-toggle="tab" id="kt_charts_widget_35_tab_3"
                                            href="#kt_charts_widget_35_tab_content_3">1ay</a>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                            data-bs-toggle="tab" id="kt_charts_widget_35_tab_4"
                                            href="#kt_charts_widget_35_tab_content_4">6ay</a>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
                                            data-bs-toggle="tab" id="kt_charts_widget_35_tab_5"
                                            href="#kt_charts_widget_35_tab_content_5">1yıl</a>
                                    </li>
                                </ul>
