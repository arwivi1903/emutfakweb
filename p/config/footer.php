<div id="kt_app_footer" class="app-footer">
    <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
        ...
        <div class="text-dark order-1 order-md-2">
            <span class="text-muted fw-semibold">Version <span class="badge badge-light-info">1.0.0</span></span>
        </div>
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <img alt="dist/apps/projects/project.html" class="w-30px me-3"
                                            src="dist/assets/media/svg/files/doc.svg" />
                                        <div class="ms-1 fw-semibold">
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <img alt="dist/apps/projects/project.html" class="w-30px me-3"
                                            src="dist/assets/media/svg/files/css.svg" />
                                        <div class="ms-1 fw-semibold">
                            ...
                            <div class="overflow-auto pb-5">
                                <div
                                    ...
                                    <div class="overlay me-10">
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="dist/assets/media/stock/600x400/img-29.jpg" />
                                        </div>
                                    ...
                                    <div class="overlay me-10">
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="dist/assets/media/stock/600x400/img-31.jpg" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                            <a href="#" class="btn btn-sm btn-primary btn-shadow">Explore</a>
                                        </div>
                                    ...
                                    <div class="overlay">
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px"
                                                src="dist/assets/media/stock/600x400/img-40.jpg" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                            <a href="#" class="btn btn-sm btn-primary btn-shadow">Explore</a>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                <img src="dist/assets/media/svg/card-logos/visa.svg" alt=""
                                                    class="h-25px" />
                                                <img src="dist/assets/media/svg/card-logos/mastercard.svg" alt=""
                                                    class="h-25px" />
                                                <img src="dist/assets/media/svg/card-logos/american-express.svg" alt=""
                                                    class="h-25px" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="dist/assets/media/illustrations/sketchy-1/9.png" alt=""
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="dist/assets/media/illustrations/sketchy-1/1.png" alt=""
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="dist/assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Invite
                    Gmail Contacts
                </div>
...
window.initDataTable = function(selector, opts) {
    ...
    $table.DataTable($.extend(true, {}, defaults, opts || {}));
};
</script>
