                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                            <a href="index.html" class="text-muted text-hover-primary"><?php echo "Home"; ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                        <li class="breadcrumb-item text-muted"><?php echo ("index.php" == "index.php") ? "Dashboards" : getPageName(); ?></li>
                    </ul>
                </div>
                            ...
                            <div class="card-body d-flex flex-column justify-content-end pe-0">
                                ...
                                <div class="symbol-group symbol-hover flex-nowrap">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        ...
                                        <img alt="Pic" src="dist/assets/media/avatars/300-11.jpg" />
                                    </div>
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Susan Redwood">
                                    ...
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Melody Macy">
                                        <img alt="Pic" src="dist/assets/media/avatars/300-2.jpg" />
                                    </div>
                                    <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                        title="Perry Matthew">
                        ...
                        <div class="card card-flush h-md-100">
                            <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0"
                                ...
                                <img class="mx-auto h-150px h-lg-200px theme-light-show"
                                    src="dist/assets/media/illustrations/misc/upgrade.svg" alt="" />
                                <img class="mx-auto h-150px h-lg-200px theme-dark-show"
                                    src="dist/assets/media/illustrations/misc/upgrade-dark.svg" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-3.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-2.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-9.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-7.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-25.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-24.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-20.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-17.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-11.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-23.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-4.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-1.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-12.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-21.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-30.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-14.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-6.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-50px me-3">
                                                                    <img src="dist/assets/media/avatars/300-10.jpg" class=""
                                                                        alt="" />
                                                                </div>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <a href="dist/pages/user-profile/overview.html"
                                                ...
                                                <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                    <div class="d-flex align-items-center me-5 me-xl-13">
                                                        <div class="symbol symbol-30px symbol-circle me-3">
                                                            <img src="dist/assets/media/avatars/300-3.jpg" class="" alt="" />
                                                        </div>
                                                        <div class="m-0">
                                                            <span
                                            ...
                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                <div class="symbol-group symbol-hover flex-nowrap">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle"
                                                        ...
                                                        <img alt="Pic" src="dist/assets/media/avatars/300-3.jpg" />
                                                    </div>
                                                    <div class="symbol symbol-35px symbol-circle"
                                                ...
                                                <a href="dist/apps/projects/project.html"
                    ...
                    <div class="col-xl-8">
                        <div class="card card-flush h-md-100">
                            <div class="card-header pt-7">
                                ...
                                <div class="card-toolbar">
                                    <a href="dist/apps/ecommerce/catalog/add-product.html"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="dist/assets/media/stock/600x600/img-49.jpg" class=""
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="dist/assets/media/stock/600x600/img-40.jpg" class=""
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="dist/assets/media/stock/600x600/img-39.jpg" class=""
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="dist/assets/media/stock/600x600/img-47.jpg" class=""
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="symbol symbol-50px me-3">
                                                            <img src="dist/assets/media/stock/600x600/img-48.jpg" class=""
                                                                alt="" />
                                                        </div>
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
