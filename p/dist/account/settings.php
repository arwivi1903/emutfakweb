...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            style="background-image: url('dist/assets/media/svg/avatars/blank.svg')">
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url(dist/assets/media/avatars/300-1.jpg)"></div>
                                            <label
                ...
                <div class="card">
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Kullanıcı Pasif Yap</h3>
                        </div>
                    </div>
                            ...
                            <div class="card-body border-top p-9">
                                <div
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        <div class="fw-semibold">
                                            <h4 class="text-gray-900 fw-bold">Hesabınızı Pasif Hale Getiriyorsunuz</h4>
                                            <div class="fs-6 text-gray-700">Ekstra güvenlik için, şifrenizi
                                                sıfırladığınızda e-posta veya telefon numaranızı doğrulamanız
                                                gerekmektedir.
                                                <br />
                                                <a class="fw-bold" href="#">Daha fazla bilgi edinin</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-check form-check-solid fv-row">
                                    <input name="deactivate" class="form-check-input" type="checkbox" value=""
                                        id="deactivate" />
                                    <label class="form-check-label fw-semibold ps-2 fs-6" for="deactivate">Hesabımı
                                        pasif hale getirmeyi onaylıyorum</label>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button id="kt_account_deactivate_account_submit" type="submit"
                                    class="btn btn-danger fw-semibold">Hesabı Pasif Yap</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
    // Hesabı pasif yapma form işleme
    document.getElementById('kt_account_deactivate_form').addEventListener('submit', function(e) {
        ...
        if (!deactivateCheckbox.checked) {
            Swal.fire({
                icon: 'warning',
                title: 'Dikkat!',
                text: 'Lütfen hesabınızı pasif hale getirmeyi onaylamak için kutucuğu işaretleyiniz.',
        ...
        Swal.fire({
            icon: 'question',
            title: 'Hesabı Pasif Yap',
            text: 'Hesabınızı pasif hale getirmek istediğinizden emin misiniz? Bu işlem geri alınamaz.',
            ...
            cancelButtonColor: '#6c757d'
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('dist/api/api.php?action=deactivate_account', {
                            method: 'POST',
                            headers: {
                            ...
                            body: JSON.stringify({
                                deactivate: deactivateCheckbox.checked
                            })
                        })
                        .then(response => {
                            ...
                            // Eğer response.ok değilse hata ver
                            if (!response.ok) {
                        ...
                        .then(({ status, data }) => {
                            ...
                            if (data.success) {
                                ...
                                const errorMsg = data.error_debug ? data.error_debug : data.message;
                        ...
                        .catch(error => {
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Hata!',
                                text: 'Bir hata oluştu: ' + error.message + '. Lütfen daha sonra tekrar deneyiniz.',
                                confirmButtonText: 'Tamam'
                            });
                        });
                }
