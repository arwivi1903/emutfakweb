...
if (isset($_POST["customer_id"]) && is_numeric($_POST["customer_id"])) {
    ...
    if ($sil > 0) {
        ...
        if ($customer && $customer->status === 'suspended') {
            // Zaten pasif durumda
            header('Location: dist/apps/customers/list.php?already_passive=1');
            exit;
        }
        ...
        if ($customer) {
            ...
            if ($musterisil) {
                header('Location: dist/apps/customers/list.php?deleted=1');
                exit;
            }else{
                header('Location: dist/apps/customers/list.php?error=1');
                exit;
            }
        } else {
...
function createSortLink($key, $label, $currentSort, $currentDir) {
    ...
    $href = 'dist/apps/customers/list.php?sort=' . $key . '&dir=' . $nextDir . '&page=1';
                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <a href="dist/apps/customers/add.php" class="btn btn-sm btn-light-primary">
                        ...
                        <form method="get" action="">
                            <div class="row mb-5">
                                ...
                                <div class="col-md-4 text-end">
                                    ...
                                    <a href="dist/apps/customers/list.php" class="btn btn-light-secondary">
                            ...
                            <div class="letter-filter-modern mb-3">
                                ...
                                if (!function_exists('buildLetterLink')) {
                                    function buildLetterLink($letterValue) {
                                        ...
                                        return 'dist/apps/customers/list.php?' . http_build_query($params);
                                    }
                                }
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="dist/apps/customers/detail.php?id=<?php echo (int)($customer->customer_id ?? 0); ?>" class="text-gray-900 fw-bold text-hover-primary"><?php echo htmlspecialchars($customer->company_name ?? ''); ?></a>
...
function deleteCustomer(id, name) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = 'dist/apps/customers/list.php';
